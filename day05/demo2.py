...
db=conn.lagou_cd                   #连接lagou数据库，没有则自动创建
...
# 拉勾主页
url1='https://www.lagou.com/jobs/list_{}?city=%e6%88%90%e9%83%bd'
# 拉勾所有职位信息
url2='https://www.lagou.com/jobs/positionAjax.json?city=%e6%88%90%e9%83%bd&needAddtionalResult=false'
# 拉勾具体职位信息
url3='https://www.lagou.com/jobs/{}.html'

def getInfo(url):
    headers={'User-Agent': random.choice(user_agent),
             'Referer': 'https://www.lagou.com/jobs/list_python?city=%e6%88%90%e9%83%bd&cl=false&fromSearch=true&labelWords=&suginput=&labelWords=hot',
...
for page in range(1,31):
    ...
    # 提交表单数据，做post申请
    r=requests.post(url2,headers=headers,cookies=cookies,data=data)
    r.encoding='utf-8'
    # 获取json数据
    result=r.json()
